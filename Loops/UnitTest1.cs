...
namespace _04_Loops
{
    ...
    public class UnitTest1
    {
        ...
        public void ForLoops()
        {
            ...
            // 3 - do between loops or after each loop
            ...
            for (Random randy = new Random(); randy.Next(0, 10) != 8; Console.WriteLine("ahh"))
            {
        ...
        public void forEachLoops()
        {
            ...
            foreach (char letter in "Josh Hambright")
            {
                Console.WriteLine(letter);
                Console.WriteLine("Josh Hambright"[3]);
            }
        }
